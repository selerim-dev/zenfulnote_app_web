...
export function ProductDeck() {
  ...
  return (
    <div className="relative mx-auto h-[390px] w-full max-w-[680px] overflow-hidden sm:h-[560px] lg:h-[620px]">
      ...
      <div className="absolute bottom-6 left-4 z-[5] hidden max-w-[280px] rounded-2xl border border-black/10 bg-white/90 p-4 shadow-[0_20px_80px_rgba(0,0,0,0.10)] backdrop-blur sm:block">
